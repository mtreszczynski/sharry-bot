...
POSITIVE_KEYWORDS = ["так", "да", "цікаво", "tak", "da", "yes", "дуже", "ok", "ок", "super", "супер", "підходить", "мені підходить"]
...
🎥 TikTok https://www.tiktok.com/@sharry.com.ua
...
# lista pytań – dokładnie ta sama treść, tylko rozbita na 12 elementów
QUESTIONS_LIST = [
    ...
    "12. Важливий нюанс: після двох місяців роботи відкриття ФОП є обов'язковим для офіційної виплати зарплати оскільки компанія польська (вказано в оголошенні), фірма сплачує всі податки та надає безкоштовні консультації нашого бухгалтера. До цього моменту виплата відбувається на карту. Скажіть, якщо після 2 місяців вас все влаштовуватиме, ви готові відкрити ФОП?"
